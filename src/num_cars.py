...
from pyspark.sql.types import StringType, IntegerType, ArrayType, TimestampType
from pyspark.sql.functions import concat, count, split, col, from_json, from_csv, udf, expr
from pyspark.sql.functions import lit, window, unix_timestamp, count, max, first, struct
...
query = ultimi_avvistamenti.select(concat(
    "targa", lit(" "),
    "timestamp", lit(" "),
    "tratto", lit(" "),
    "ingresso", lit(" "),
